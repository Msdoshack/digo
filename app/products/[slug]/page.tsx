          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-6">
            ...
            <div className="text-sm">
              ...
              <p>
                ...
                veniam sint aliquam, praesentium delectus repudiandae explicabo,
                ullam debitis reiciendis facere suscipit odit. In accusamus
                labore quas pariatur nisi accusantium inventore.
              </p>
            </div>
