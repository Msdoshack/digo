...
const page = async ({ params }: { params: Params }) => {
  ...
  return (
    <>
      ...
      {!product?.isAvailable && (
        <div className="fixed w-screen h-screen flex items-center justify-center bg-[#00000090] overflow-y-hidden z-10 top-0 left-0`">
          <p className="p-2 bg-white text-red-500 rounded-sm">Out Of Stock</p>
        </div>
      )}
    </>
  );
